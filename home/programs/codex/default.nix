...
let
  ...
  mattPocockHandoffSkill = mkMattPocockSkill {
    name = "handoff";
  ...
  mattPocockDomainModelingSkill = mkMattPocockSkill {
  ...
  mattPocockResolvingMergeConflictsSkill = mkMattPocockSkill {
...
in
{
  ...
  config = {
    ...
    home.file.".agents/skills/playwright-cli".source = playwrightCliSkill;
    ...
    home.file.".agents/skills/handoff" = lib.mkIf config.dotfiles.codex.mattPocockSkills.enable {
      source = mattPocockHandoffSkill;
    };
    home.file.".agents/skills/domain-modeling" =
      lib.mkIf config.dotfiles.codex.mattPocockSkills.enable
        {
          source = mattPocockDomainModelingSkill;
        };
    home.file.".agents/skills/resolving-merge-conflicts" =
      lib.mkIf config.dotfiles.codex.mattPocockSkills.enable
        {
          source = mattPocockResolvingMergeConflictsSkill;
        };
